...
export function streamGenerateDraftRun(params: {
  storyTitle: string;
  direction: string;
  context: ChapterContext;
  signal?: AbortSignal;
...
export function streamReviseDraftRun(params: {
  currentDraft: string;
  command: string;
  context: ChapterContext;
  signal?: AbortSignal;
...
function generateDraftRequest(params: {
  storyTitle: string;
  direction: string;
  context: ChapterContext;
}) {
